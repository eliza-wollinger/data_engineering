...
def main():
    ...
    nba_player_box_score_stats_data = read_player_box_score_stats_data('nba_player_box_score_stats.csv')
    ...
    insert_nba_data(cur, nba_playroll_data, nba_player_box_score_stats_data, nba_player_stats_data, nba_salaries_data)
